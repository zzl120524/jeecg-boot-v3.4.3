...
//        return TokenUtils.verifyToken(token, commonApi, redisUtil);
        return TokenUtils.verifyToken(token, commonApi, null);
    }
...
//        LoginUser user = TokenUtils.getLoginUser(username, commonApi, redisUtil);
        LoginUser user = TokenUtils.getLoginUser(username, commonApi, null);
...
/*        if (!jwtTokenRefresh(token, username, user.getPassword(), null)) {
